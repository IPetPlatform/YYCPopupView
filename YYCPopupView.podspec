...
Pod::Spec.new do |s|
  s.name             = 'YYCPopupView'
  s.version          = '0.1.0'
  s.summary          = 'A short description of YYCPopupView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/troyan1989/YYCPopupView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'troyan1989' => 'troyan07me@163.com' }
  s.source           = { :git => 'https://github.com/troyan1989/YYCPopupView.git', :tag => s.version.to_s }
